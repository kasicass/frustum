...
void init(HWND hDlg) {
    ...
    ComboBox_AddString(GetDlgItem(hDlg,IDC_MODE),L"640x480 - 16 bit");
    ComboBox_AddString(GetDlgItem(hDlg,IDC_MODE),L"640x480 - 32 bit");
    ComboBox_AddString(GetDlgItem(hDlg,IDC_MODE),L"800x600 - 16 bit");
    ComboBox_AddString(GetDlgItem(hDlg,IDC_MODE),L"800x600 - 32 bit");
    ComboBox_AddString(GetDlgItem(hDlg,IDC_MODE),L"1024x768 - 16 bit");
    ComboBox_AddString(GetDlgItem(hDlg,IDC_MODE),L"1024x768 - 32 bit");
    ComboBox_AddString(GetDlgItem(hDlg,IDC_MODE),L"1280x1024 - 16 bit");
    ComboBox_AddString(GetDlgItem(hDlg,IDC_MODE),L"1280x1024 - 32 bit");
    ComboBox_AddString(GetDlgItem(hDlg,IDC_MODE),L"1600x1200 - 16 bit");
    ComboBox_AddString(GetDlgItem(hDlg,IDC_MODE),L"1600x1200 - 32 bit");
    i = -1;
